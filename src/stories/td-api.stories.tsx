...
export const CreateTodolists = () => {
	...
	useEffect(() => {
		...
		todolistsAPI.createTodolist('bla bla bla')
			.then((res) => {
				// debugger
...
export const updateTasks = () => {
	...
	const updateTask = () => {
		...
		todolistsAPI.updateTask(todolistId, tasktId, model)
			.then((res) => {
				setState(res.data)
			})
	}
	...
	return <>
					<div>{JSON.stringify(state)}</div>
					<input type="text" placeholder="Task Title" value={title} onChange={(e) => { setTitle(e.currentTarget.value) }} />
					<input type="text" placeholder="Task Id" value={tasktId} onChange={(e) => { setTaskId(e.currentTarget.value) }} />
					<input type="text" placeholder="Todolist Id" value={todolistId} onChange={(e) => { setTodolistId(e.currentTarget.value) }} />
