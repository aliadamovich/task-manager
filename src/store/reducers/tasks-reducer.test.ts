...
import { addTaskAС, updateTaskAC, removeTaskAC, setTasksAC, tasksReducer, TaskStateType } from "./tasks-reducer";
...
test('title of specified task should be changed', () => {
    ...
    const action = updateTaskAC("todolistId2", "2", {title: "juice"});
