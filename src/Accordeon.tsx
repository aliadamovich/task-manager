...
export const AccordeonData = [
	{
		...
		{id: 4, title: 'Header 4', content: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maxime similique, corrupti impedit vero explicabo eveniet fuga. Eaque ea rerum harum atque velit nihil, aliquam earum, itaque molestiae unde, ad a'},
		{id: 5, title: 'Header 5', content: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maxime similique, corrupti impedit vero explicabo eveniet fuga. Eaque ea rerum harum atque velit nihil, aliquam earum, itaque molestiae unde, ad a'},
...
export const AccBody = styled.div<AccordeopnType>`
	...
	${props => props.isOpen && css<AccordeopnType>`
	${Content} {
		display: block;
	}
	${Icon} {
